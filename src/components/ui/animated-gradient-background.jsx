...
const AnimatedGradientBackground = ({
   ...
   return (
      <motion.div
         ...
         style={{ zIndex: -1, position: "fixed", top: 0, left: 0, right: 0, bottom: 0, overflow: "hidden" }} // Make sure it's in the background
      >
         <div
            ref={containerRef}
            style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, transition: "transform", ...containerStyle }}
         />
      </motion.div>
   );
};
